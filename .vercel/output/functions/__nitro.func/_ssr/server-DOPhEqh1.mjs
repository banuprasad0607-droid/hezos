...
import {
  k as defineHandlerCallback,
  L as resolveManifestAssetLink,
  M as resolveManifestCssLink,
  N as rootRouteId,
  q as getNormalizedURL,
  r as getOrigin,
  H as normalizeSsrResponse,
  c as attachRouterServerSsrUtils,
  g as createSerializationAdapter,
  f as createRawStreamRPCPlugin,
  w as invariant,
  z as isNotFound,
  A as isRedirect,
  C as isResolvedRedirect,
  K as replaceSsrResponse,
  G as mergeHeaders,
  n as executeRewriteInput,
  O as stripSsrResponseBody,
  j as defaultSerovalPlugins,
  F as makeSerovalPlugin,
  s as getScriptPreloadAttrs,
  u as getStylesheetHref,
  E as isSsrResponse,
  I as parseRedirect,
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CGJedJb1.mjs");
...
const manifest = {
  "0b555f14295dc8bb51ce806a00ff7f2f77bcfbe15bed2747495355e8757e2db7": {
    functionName: "bootstrapOwnSchool_createServerFn_handler",
    importer: () => import("./platform.functions-DqRXX8zN.mjs"),
  },
  "133844214a4719bda90889cd9afc62d29e0c7841cbe15401eb91c1345a8a4771": {
    functionName: "getSchoolCredentials_createServerFn_handler",
    importer: () => import("./platform.functions-DqRXX8zN.mjs"),
  },
  "167edb1c60030c9184e6d11128b4ea90f01d5a02d17005feca7fc87c6859134d": {
    functionName: "loginAttemptServer_createServerFn_handler",
    importer: () => import("./platform.functions-DqRXX8zN.mjs"),
  },
  "58ddf5d25e1dfb1dd783a74fb6c21b95be7cb5f10822e4b6efda608e38293daa": {
    functionName: "resetPasswordEmailServer_createServerFn_handler",
    importer: () => import("./platform.functions-DqRXX8zN.mjs"),
  },
  "6193ca6393ff03622607c8e55de2002fd953e53dcbd843c85041be86c59fb8d2": {
    functionName: "provisionTeacher_createServerFn_handler",
    importer: () => import("./platform.functions-DqRXX8zN.mjs"),
  },
  "74b7c266f17fc6d5b1c13c80e08d7e19423388a35e64756457927e70d6973987": {
    functionName: "provisionStudent_createServerFn_handler",
    importer: () => import("./platform.functions-DqRXX8zN.mjs"),
  },
  c7daddccdc4a017418bf0449431ca08cd5c578b6a1bf52bd6661311bcd53d9e8: {
    functionName: "resetAdminPassword_createServerFn_handler",
    importer: () => import("./platform.functions-DqRXX8zN.mjs"),
  },
  f5a10fa45077857e4d1ccffd01555f31e38f2fc7acf0424e1a6e7a1422ff961a: {
    functionName: "provisionSchool_createServerFn_handler",
    importer: () => import("./platform.functions-DqRXX8zN.mjs"),
  },
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CplsJ0Ue.mjs").then((n) => n.r),
    import("./start-2YsciWeM.mjs"),
