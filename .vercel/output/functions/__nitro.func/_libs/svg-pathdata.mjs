  ...
  (function (module, exports) {
    !(function (t, r) {
      ...
      function e(t2, e2) {
        ...
        (r(t2, e2),
          (t2.prototype =
            null === e2 ? Object.create(e2) : ((a2.prototype = e2.prototype), new a2())));
      }
      var a = " ";
      function i(t2) {
        var r2 = "";
        ...
        for (var e2 = 0; e2 < t2.length; e2++) {
          ...
          if (i2.type === N.CLOSE_PATH) r2 += "z";
            ...
            r2 +=
              ...
              a +
              i2.y;
          else if (i2.type === N.SMOOTH_CURVE_TO)
            r2 += (i2.relative ? "s" : "S") + i2.x2 + a + i2.y2 + a + i2.x + a + i2.y;
          else if (i2.type === N.QUAD_TO)
            r2 += (i2.relative ? "q" : "Q") + i2.x1 + a + i2.y1 + a + i2.x + a + i2.y;
      ...
      function u(t2, r2, e2) {
        ...
        var h2 = n([(r2 - o2) / 2, (e2 - u2) / 2], (-t2.xRot / 180) * s),
          c2 = h2[0],
          m2 = h2[1],
          y2 = Math.pow(c2, 2) / Math.pow(a2, 2) + Math.pow(m2, 2) / Math.pow(i2, 2);
        (1 < y2 && ((a2 *= Math.sqrt(y2)), (i2 *= Math.sqrt(y2))), (t2.rX = a2), (t2.rY = i2));
        var p2 = Math.pow(a2, 2) * Math.pow(m2, 2) + Math.pow(i2, 2) * Math.pow(c2, 2),
          f2 =
            (t2.lArcFlag !== t2.sweepFlag ? 1 : -1) *
            Math.sqrt(Math.max(0, (Math.pow(a2, 2) * Math.pow(i2, 2) - p2) / p2)),
          T2 = ((a2 * m2) / i2) * f2,
          O2 = ((-i2 * c2) / a2) * f2,
          l2 = n([T2, O2], (t2.xRot / 180) * s);
        ((t2.cX = l2[0] + (r2 + o2) / 2),
          (t2.cY = l2[1] + (e2 + u2) / 2),
          (t2.phi1 = Math.atan2((m2 - O2) / i2, (c2 - T2) / a2)),
          (t2.phi2 = Math.atan2((-m2 - O2) / i2, (-c2 - T2) / a2)),
          0 === t2.sweepFlag && t2.phi2 > t2.phi1 && (t2.phi2 -= 2 * s),
          1 === t2.sweepFlag && t2.phi2 < t2.phi1 && (t2.phi2 += 2 * s),
          (t2.phi1 *= 180 / s),
          (t2.phi2 *= 180 / s));
      }
      function h(t2, r2, e2) {
        ...
        var i2 = Math.sqrt(a2);
        return [
          [(t2 * e2 + r2 * i2) / (t2 * t2 + r2 * r2), (r2 * e2 - t2 * i2) / (t2 * t2 + r2 * r2)],
          [(t2 * e2 - r2 * i2) / (t2 * t2 + r2 * r2), (r2 * e2 + t2 * i2) / (t2 * t2 + r2 * r2)],
        ];
      }
      var c = Math.PI / 180;
      ...
      function p(t2, r2, e2, a2) {
        var i2 = 1e-6,
          n2 = r2 - t2,
          o2 = e2 - r2,
          s2 = 3 * n2 + 3 * (a2 - e2) - 6 * o2,
          u2 = 6 * (o2 - n2),
          h2 = 3 * n2;
        return Math.abs(s2) < i2
          ? [-h2 / u2]
          : (function (t3, r3, e3) {
              var a3 = (t3 * t3) / 4 - r3;
              if (a3 < -e3) return [];
      ...
      ((t.SVGPathDataTransformer = void 0),
        (function (t2) {
          function r2() {
          ...
          function e2() {
            ...
            return i2(function (i3, n2, o2) {
              return (
                i3.type & N.SMOOTH_CURVE_TO &&
                  ((i3.type = N.CURVE_TO),
                  (t3 = isNaN(t3) ? n2 : t3),
                  (r3 = isNaN(r3) ? o2 : r3),
                  (i3.x1 = i3.relative ? n2 - t3 : 2 * n2 - t3),
                  (i3.y1 = i3.relative ? o2 - r3 : 2 * o2 - r3)),
                i3.type & N.CURVE_TO
                  ? ((t3 = i3.relative ? n2 + i3.x2 : i3.x2),
                    (r3 = i3.relative ? o2 + i3.y2 : i3.y2))
                  : ((t3 = NaN), (r3 = NaN)),
                i3.type & N.SMOOTH_QUAD_TO &&
                  ((i3.type = N.QUAD_TO),
                  (e3 = isNaN(e3) ? n2 : e3),
                  (a3 = isNaN(a3) ? o2 : a3),
                  (i3.x1 = i3.relative ? n2 - e3 : 2 * n2 - e3),
                  (i3.y1 = i3.relative ? o2 - a3 : 2 * o2 - a3)),
                i3.type & N.QUAD_TO
                  ? ((e3 = i3.relative ? n2 + i3.x1 : i3.x1),
                    (a3 = i3.relative ? o2 + i3.y1 : i3.y1))
                  : ((e3 = NaN), (a3 = NaN)),
                i3
              );
            });
          ...
          function a2() {
            ...
            return i2(function (e3, a3, i3) {
              if (
                (e3.type & N.SMOOTH_QUAD_TO &&
                  ((e3.type = N.QUAD_TO),
                  (t3 = isNaN(t3) ? a3 : t3),
                  (r3 = isNaN(r3) ? i3 : r3),
                  (e3.x1 = e3.relative ? a3 - t3 : 2 * a3 - t3),
                  (e3.y1 = e3.relative ? i3 - r3 : 2 * i3 - r3)),
                e3.type & N.QUAD_TO)
              ) {
                ...
                var n2 = e3.x1,
                  o2 = e3.y1;
                ((e3.type = N.CURVE_TO),
                  (e3.x1 = ((e3.relative ? 0 : a3) + 2 * n2) / 3),
                  (e3.y1 = ((e3.relative ? 0 : i3) + 2 * o2) / 3),
                  (e3.x2 = (e3.x + 2 * n2) / 3),
                  (e3.y2 = (e3.y + 2 * o2) / 3));
              } else ((t3 = NaN), (r3 = NaN));
              return e3;
          ...
          function i2(t3) {
            var r3 = 0,
              ...
              i3 = NaN;
            return function (n2) {
              if (isNaN(a3) && !(n2.type & N.MOVE_TO))
                throw new Error("path must start with moveto");
              var o2 = t3(n2, r3, e3, a3, i3);
              return (
                n2.type & N.CLOSE_PATH && ((r3 = a3), (e3 = i3)),
                void 0 !== n2.x && (r3 = n2.relative ? r3 + n2.x : n2.x),
                void 0 !== n2.y && (e3 = n2.relative ? e3 + n2.y : n2.y),
                n2.type & N.MOVE_TO && ((a3 = r3), (i3 = e3)),
                o2
              );
            };
          }
          function s2(t3, r3, e3, a3, n2, s3) {
            return (
              o(t3, r3, e3, a3, n2, s3),
              i2(function (i3, o2, u2, h2) {
                var c2 = i3.x1,
                  m2 = i3.x2,
                  y2 = i3.relative && !isNaN(h2),
                  p2 = void 0 !== i3.x ? i3.x : y2 ? 0 : o2,
                  f2 = void 0 !== i3.y ? i3.y : y2 ? 0 : u2;
                function T3(t4) {
                  return t4 * t4;
                }
                (i3.type & N.HORIZ_LINE_TO &&
                  0 !== r3 &&
                  ((i3.type = N.LINE_TO), (i3.y = i3.relative ? 0 : u2)),
                  i3.type & N.VERT_LINE_TO &&
                    0 !== e3 &&
                    ((i3.type = N.LINE_TO), (i3.x = i3.relative ? 0 : o2)),
                  void 0 !== i3.x && (i3.x = i3.x * t3 + f2 * e3 + (y2 ? 0 : n2)),
                  void 0 !== i3.y && (i3.y = p2 * r3 + i3.y * a3 + (y2 ? 0 : s3)),
                  void 0 !== i3.x1 && (i3.x1 = i3.x1 * t3 + i3.y1 * e3 + (y2 ? 0 : n2)),
                  void 0 !== i3.y1 && (i3.y1 = c2 * r3 + i3.y1 * a3 + (y2 ? 0 : s3)),
                  void 0 !== i3.x2 && (i3.x2 = i3.x2 * t3 + i3.y2 * e3 + (y2 ? 0 : n2)),
                  void 0 !== i3.y2 && (i3.y2 = m2 * r3 + i3.y2 * a3 + (y2 ? 0 : s3)));
                var O2 = t3 * a3 - r3 * e3;
                if (void 0 !== i3.xRot && (1 !== t3 || 0 !== r3 || 0 !== e3 || 1 !== a3))
                  if (0 === O2)
                    ...
                    var l2 = (i3.xRot * Math.PI) / 180,
                      ...
                      E = 2 * v2 * _2 * (d2 - x),
                      C = T3(v2) * d2 + T3(_2) * x,
                      M = A * a3 * a3 - E * r3 * a3 + C * r3 * r3,
                      R = E * (t3 * a3 + r3 * e3) - 2 * (A * e3 * a3 + C * t3 * r3),
                      S = A * e3 * e3 - E * t3 * e3 + C * t3 * t3,
                      g = ((Math.atan2(R, M - S) + Math.PI) % Math.PI) / 2,
                      I = Math.sin(g),
                      V = Math.cos(g);
                    ((i3.rX = Math.abs(O2) / Math.sqrt(M * T3(V) + R * I * V + S * T3(I))),
                      (i3.rY = Math.abs(O2) / Math.sqrt(M * T3(I) - R * I * V + S * T3(V))),
                      (i3.xRot = (180 * g) / Math.PI));
                  }
          ...
          ((t2.ROUND = function (t3) {
            ...
            (t2.NORMALIZE_HVZ = function (t3, r3, e3) {
              return (
                ...
                void 0 === r3 && (r3 = true),
                void 0 === e3 && (e3 = true),
                i2(function (a3, i3, n2, o2, s3) {
                  if (isNaN(o2) && !(a3.type & N.MOVE_TO))
                    throw new Error("path must start with moveto");
                  return (
                    r3 &&
                      a3.type & N.HORIZ_LINE_TO &&
                      ((a3.type = N.LINE_TO), (a3.y = a3.relative ? 0 : n2)),
                    e3 &&
                      a3.type & N.VERT_LINE_TO &&
                      ((a3.type = N.LINE_TO), (a3.x = a3.relative ? 0 : i3)),
                    t3 &&
                      a3.type & N.CLOSE_PATH &&
                      ((a3.type = N.LINE_TO),
                      (a3.x = a3.relative ? o2 - i3 : o2),
                      (a3.y = a3.relative ? s3 - n2 : s3)),
                    a3.type & N.ARC &&
                      (0 === a3.rX || 0 === a3.rY) &&
                      ((a3.type = N.LINE_TO),
                      delete a3.rX,
            ...
            (t2.SANITIZE = function (t3) {
              ...
              return i2(function (i3, o2, s3, u2, h2) {
                ...
                if (
                  (i3.type & N.SMOOTH_CURVE_TO &&
                    ((y2 = isNaN(r3) ? 0 : o2 - r3), (p2 = isNaN(e3) ? 0 : s3 - e3)),
                  i3.type & (N.CURVE_TO | N.SMOOTH_CURVE_TO)
                    ? ((r3 = i3.relative ? o2 + i3.x2 : i3.x2),
                      (e3 = i3.relative ? s3 + i3.y2 : i3.y2))
                    : ((r3 = NaN), (e3 = NaN)),
                  i3.type & N.SMOOTH_QUAD_TO
                    ? ((a3 = isNaN(a3) ? o2 : 2 * o2 - a3), (n2 = isNaN(n2) ? s3 : 2 * s3 - n2))
                    : i3.type & N.QUAD_TO
                      ? ((a3 = i3.relative ? o2 + i3.x1 : i3.x1),
                        (n2 = i3.relative ? s3 + i3.y1 : i3.y2))
                      : ((a3 = NaN), (n2 = NaN)),
                  i3.type & N.LINE_COMMANDS ||
                    (i3.type & N.ARC && (0 === i3.rX || 0 === i3.rY || !i3.lArcFlag)) ||
                    i3.type & N.CURVE_TO ||
                    i3.type & N.SMOOTH_CURVE_TO ||
                    i3.type & N.QUAD_TO ||
                    i3.type & N.SMOOTH_QUAD_TO)
                ) {
                  var f2 = void 0 === i3.x ? 0 : i3.relative ? i3.x : i3.x - o2,
                    T3 = void 0 === i3.y ? 0 : i3.relative ? i3.y : i3.y - s3;
                  ((y2 = isNaN(a3)
                    ? void 0 === i3.x1
                      ? y2
                      : i3.relative
                    ...
                    (p2 = isNaN(n2)
                      ? void 0 === i3.y1
                        ...
                        : i3.relative
                          ...
                          : i3.y1 - s3
                      : n2 - s3));
                  var O2 = void 0 === i3.x2 ? 0 : i3.relative ? i3.x : i3.x2 - o2,
                    l2 = void 0 === i3.y2 ? 0 : i3.relative ? i3.y : i3.y2 - s3;
                  c2(f2) <= t3 &&
                    c2(T3) <= t3 &&
                    c2(y2) <= t3 &&
                    c2(p2) <= t3 &&
                ...
                return (
                  i3.type & N.CLOSE_PATH && c2(o2 - u2) <= t3 && c2(s3 - h2) <= t3 && (m2 = true),
                  m2 ? [] : i3
                );
              });
            }),
            ...
            (t2.A_TO_C = function () {
              return i2(function (t3, r3, e3) {
                return N.ARC === t3.type
                  ? (function (t4, r4, e4) {
                      var a3, i3, o2, s3;
                      t4.cX || u(t4, r4, e4);
                      for (
                        var h2 = Math.min(t4.phi1, t4.phi2),
                          y2 = Math.max(t4.phi1, t4.phi2) - h2,
                          p2 = Math.ceil(y2 / 90),
                          f2 = new Array(p2),
                          T3 = r4,
                          O2 = e4,
                        ...
                        var v2 = m(t4.phi1, t4.phi2, l2 / p2),
                          _2 = m(t4.phi1, t4.phi2, (l2 + 1) / p2),
                          d2 = _2 - v2,
                          x = (4 / 3) * Math.tan((d2 * c) / 4),
                          A = [
                            Math.cos(v2 * c) - x * Math.sin(v2 * c),
                            Math.sin(v2 * c) + x * Math.cos(v2 * c),
                          ],
                          E = A[0],
                          C = A[1],
                          M = [Math.cos(_2 * c), Math.sin(_2 * c)],
                          R = M[0],
                          S = M[1],
                          g = [R + x * Math.sin(_2 * c), S - x * Math.cos(_2 * c)],
                          I = g[0],
                          V = g[1];
                        f2[l2] = { relative: t4.relative, type: N.CURVE_TO };
                        var D = function (r5, e5) {
                          var a4 = n([r5 * t4.rX, e5 * t4.rY], t4.xRot),
                            i4 = a4[0],
                            o3 = a4[1];
            ...
            (t2.ANNOTATE_ARCS = function () {
              return i2(function (t3, r3, e3) {
                return (
                  t3.relative && ((r3 = 0), (e3 = 0)),
                  N.ARC === t3.type && u(t3, r3, e3),
                  t3
                );
              });
            }),
            ...
            (t2.CALCULATE_BOUNDS = function () {
              var t3 = function (t4) {
                ...
                c2 = i2(function (r3, e3, a3) {
                  ...
                  if (
                    (i3.type & N.DRAWING_COMMANDS && (m2(e3), T3(a3)),
                    i3.type & N.HORIZ_LINE_TO && m2(i3.x),
                    i3.type & N.VERT_LINE_TO && T3(i3.y),
                    i3.type & N.LINE_TO && (m2(i3.x), T3(i3.y)),
                    i3.type & N.CURVE_TO)
                  ) {
                    (m2(i3.x), T3(i3.y));
                    ...
                    for (
                      var d2 = (i3.xRot / 180) * Math.PI,
                        ...
                        g = function (t4) {
                          var r4 = t4[0],
                            e4 = t4[1],
                            a4 = (180 * Math.atan2(e4, r4)) / Math.PI;
      ...
      var T,
        O = (function () {
          function r2() {}
          return (
            (r2.prototype.round = function (r3) {
        ...
        _ = (function (t2) {
          function r2() {
            ...
            return (
              (r3.curNumber = ""),
              (r3.curCommandType = -1),
              (r3.curCommandRelative = false),
              (r3.canParseCommandOrComma = true),
              (r3.curNumberHasExp = false),
              (r3.curNumberHasExpDigits = false),
              (r3.curNumberHasDecimal = false),
              (r3.curArgs = []),
              r3
            );
          }
          return (
            e(r2, t2),
            (r2.prototype.finish = function (t3) {
              if (
                (void 0 === t3 && (t3 = []),
                this.parse(" ", t3),
                        ...
                        if (this.curNumber && -1 !== this.curCommandType) {
                          ...
                          (this.curArgs.push(u2),
                            this.curArgs.length === d[this.curCommandType] &&
                              (N.HORIZ_LINE_TO === this.curCommandType
                                ? a2({
                                    type: N.HORIZ_LINE_TO,
                                    relative: this.curCommandRelative,
                                    x: u2,
                                  })
                                : N.VERT_LINE_TO === this.curCommandType
                                  ? a2({
                                      type: N.VERT_LINE_TO,
                                      relative: this.curCommandRelative,
                                      y: u2,
                                    })
                                  : this.curCommandType === N.MOVE_TO ||
                                      this.curCommandType === N.LINE_TO ||
                                      this.curCommandType === N.SMOOTH_QUAD_TO
                                    ? (a2({
                                      ...
                                      N.MOVE_TO === this.curCommandType &&
                                        (this.curCommandType = N.LINE_TO))
                                    : this.curCommandType === N.CURVE_TO
                                      ? a2({
                                          type: N.CURVE_TO,
                                          relative: this.curCommandRelative,
                                          x1: this.curArgs[0],
                                      ...
                                      : this.curCommandType === N.SMOOTH_CURVE_TO
                                        ? a2({
                          ...
                          if ("," === n2 && this.canParseCommandOrComma)
                            ...
                            if (s2) ((this.curNumber = n2), (this.curNumberHasDecimal = false));
                              ...
                              if (0 !== this.curArgs.length)
                                throw new SyntaxError("Unterminated command at index " + i2 + ".");
                              ...
                              if (((this.canParseCommandOrComma = false), "z" !== n2 && "Z" !== n2))
                                if ("h" === n2 || "H" === n2)
                                  ((this.curCommandType = N.HORIZ_LINE_TO),
                                    (this.curCommandRelative = "h" === n2));
                                else if ("v" === n2 || "V" === n2)
                                  ((this.curCommandType = N.VERT_LINE_TO),
                                  ...
                                  if ("a" !== n2 && "A" !== n2)
                                    throw new SyntaxError(
                                      'Unexpected character "' + n2 + '" at index ' + i2 + ".",
                                    );
                                  ((this.curCommandType = N.ARC),
                                    (this.curCommandRelative = "a" === n2));
                                }
                              else
                                (r3.push({ type: N.CLOSE_PATH }),
                                  (this.canParseCommandOrComma = true),
            ...
            (r2.prototype.transform = function (t3) {
              return Object.create(this, {
                parse: {
                  value: function (r3, e2) {
                    void 0 === e2 && (e2 = []);
                    for (
                      var a2 = 0, i2 = Object.getPrototypeOf(this).parse.call(this, r3);
                      a2 < i2.length;
                      a2++
                    ) {
                      var n2 = i2[a2],
        ...
        N = (function (r2) {
          ...
          return (
            ...
            (a2.LINE_TO = 16),
            (a2.CURVE_TO = 32),
            (a2.SMOOTH_CURVE_TO = 64),
            (a2.QUAD_TO = 128),
            (a2.SMOOTH_QUAD_TO = 256),
            (a2.ARC = 512),
            (a2.LINE_COMMANDS = a2.LINE_TO | a2.HORIZ_LINE_TO | a2.VERT_LINE_TO),
            (a2.DRAWING_COMMANDS =
              a2.HORIZ_LINE_TO |
              a2.VERT_LINE_TO |
              a2.LINE_TO |
        ...
        d =
          ...
          (T[N.CLOSE_PATH] = 0),
          (T[N.QUAD_TO] = 4),
          (T[N.SMOOTH_QUAD_TO] = 2),
          (T[N.CURVE_TO] = 6),
          (T[N.SMOOTH_CURVE_TO] = 4),
          (T[N.ARC] = 7),
          T);
      ((t.COMMAND_ARG_COUNTS = d),
        (t.SVGPathData = N),
        (t.SVGPathDataParser = _),
        (t.encodeSVGPath = i),
...
export { requireSVGPathData as r };
