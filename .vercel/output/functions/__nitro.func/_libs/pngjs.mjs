...
function requireBitpacker() {
  ...
  bitpacker = function (dataIn, width, height, options) {
    let outHasAlpha =
      [constants2.COLORTYPE_COLOR_ALPHA, constants2.COLORTYPE_ALPHA].indexOf(options.colorType) !==
      -1;
...
function requirePacker() {
  ...
  let Packer = (packer.exports = function (options) {
    ...
    options.colorType =
      typeof options.colorType === "number" ? options.colorType : constants2.COLORTYPE_COLOR_ALPHA;
...
function requirePackerSync() {
  ...
  packerSync = function (metaData, opt) {
    ...
    let filteredData = packer2.filterData(metaData.data, metaData.width, metaData.height);
    let compressedData = zlib.deflateSync(filteredData, packer2.getDeflateOptions());
    filteredData = null;
