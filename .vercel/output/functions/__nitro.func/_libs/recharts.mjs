...
import {
  ...
  l as shapeStack,
  r as stackOrderNone,
  q as stackOffsetWiggle,
  p as stackOffsetSilhouette,
  o as stackOffsetNone,
  n as stackOffsetExpand,
  s as shapeArea,
  k as shapeLine,
  u as stepBefore,
  t as stepAfter,
  ...
  m as monotoneX,
  f as curveLinear,
  g as curveLinearClosed,
  a as bumpY,
  b as bumpX,
  c as curveBasis,
  e as curveBasisOpen,
  d as curveBasisClosed,
} from "./d3-shape.mjs";
...
var isSingleChildEqual = function isSingleChildEqual2(nextChild, prevChild) {
  ...
  if (!isNil(nextChild) && !isNil(prevChild)) {
    ...
    var _ref2 = prevChild.props || {},
      ...
      prevProps = _objectWithoutProperties$j(_ref2, _excluded2$8);
    if (nextChildren && prevChildren) {
...
function Surface(props) {
  ...
  return /* @__PURE__ */ React.createElement(
    "svg",
    _extends$v({}, filterProps(others, true, "svg"), {
...
function _objectSpread$z(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$z(Object(t), true).forEach(function (r2) {
          _defineProperty$E(e, r2, t[r2]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$z(Object(t)).forEach(function (r2) {
            Object.defineProperty(e, r2, Object.getOwnPropertyDescriptor(t, r2));
          });
  }
  return e;
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _this$props2 = this.props,
            ...
            payload = _this$props2.payload;
          var outerStyle = _objectSpread$y(
            _objectSpread$y(
              {
                position: "absolute",
                width: width || "auto",
    ...
    [
      {
        ...
        value: function getWithHeight(item, chartWidth) {
          var _this$defaultProps$it = _objectSpread$y(
              _objectSpread$y({}, this.defaultProps),
              item.props,
            ),
...
function _slicedToArray$9(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$f(arr, i) ||
    _nonIterableRest$9()
  );
}
...
function _callSuper$g(t, o, e) {
  return (
    (o = _getPrototypeOf$g(o)),
    _possibleConstructorReturn$g(
      t,
      _isNativeReflectConstruct$g()
        ? Reflect.construct(o, e || [], _getPrototypeOf$g(t).constructor)
        : o.apply(t, e),
    )
  );
}
  ...
  return _createClass$j(TooltipBoundingBox2, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var outerStyle = _objectSpread$w(
          _objectSpread$w(
            {
              transition:
...
function _slicedToArray$7(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$d(arr, i) ||
    _nonIterableRest$7()
  );
}
...
function _slicedToArray$6(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$c(arr, i) ||
    _nonIterableRest$6()
  );
}
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ React.createElement(
    "text",
    _extends$q({}, filterProps(textProps, true), {
      x,
      y,
...
function _slicedToArray$5(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$b(arr, i) ||
    _nonIterableRest$5()
  );
}
...
var getLegendProps = function getLegendProps2(_ref) {
  ...
  var legendProps =
    legendDefaultProps !== void 0
      ? _objectSpread$s(_objectSpread$s({}, legendDefaultProps), legendItem.props)
      : {};
  var legendData;
    ...
    legendData = (formattedGraphicalItems || []).map(function (_ref3) {
      ...
      var itemProps =
        itemDefaultProps !== void 0
          ? _objectSpread$s(_objectSpread$s({}, itemDefaultProps), item.props)
          : {};
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem2(item) {
  ...
  var defaultedProps =
    (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps
      ? _objectSpread$r(_objectSpread$r({}, item.type.defaultProps), item.props)
      : item.props;
      ...
      if (barItems && barItems.length) {
        ...
        var barItemProps =
          barItemDefaultProps !== void 0
            ? _objectSpread$r(_objectSpread$r({}, barItemDefaultProps), barItems[0].props)
            : barItems[0].props;
  ...
  if (legendProps) {
    ...
    if (
      ...
      return _objectSpread$r(
        _objectSpread$r({}, offset),
        {},
        _defineProperty$u({}, align, offset[align] + (boxWidth || 0)),
      );
    }
    if (
      ...
      return _objectSpread$r(
        _objectSpread$r({}, offset),
        {},
        _defineProperty$u({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)),
      );
    }
  }
  return offset;
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId2(
  ...
  var stackGroups = items.reduce(function (result, item) {
    ...
    return _objectSpread$r(
      _objectSpread$r({}, result),
      {},
      _defineProperty$u({}, axisId, parentGroup),
    );
...
var getTooltipItem = function getTooltipItem2(graphicalItem, payload) {
  var defaultedProps = graphicalItem.type.defaultProps
    ? _objectSpread$r(_objectSpread$r({}, graphicalItem.type.defaultProps), graphicalItem.props)
    : graphicalItem.props;
  var dataKey = defaultedProps.dataKey,
    ...
    hide = defaultedProps.hide;
  return _objectSpread$r(
    _objectSpread$r({}, filterProps(graphicalItem, false)),
    {},
    {
      dataKey,
      unit,
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function (result, id) {
    ...
    var finalAxis = _objectSpread$q(
      _objectSpread$q(_objectSpread$q({}, axis), ticks),
      {},
      {
        range: range2,
        radius: outerRadius,
...
function LabelList(_ref) {
  ...
  var data = restProps.data,
    ...
    others = _objectWithoutProperties$b(restProps, _excluded2$6);
  if (!data || !data.length) {
    return null;
  }
  return /* @__PURE__ */ React.createElement(
    ...
    data.map(function (entry, index) {
      ...
      return /* @__PURE__ */ React.createElement(
        Label,
        _extends$n({}, filterProps(entry, true), others, idProps, {
...
var Curve = function Curve2(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(
    "path",
    _extends$l({}, filterProps(props, false), adaptEventHandlers(props), {
...
function _slicedToArray$3(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$6(arr, i) ||
    _nonIterableRest$3()
  );
}
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React.createElement(
      "path",
      _extends$k({}, filterProps(props, true), {
        className: layerClass,
...
function _toConsumableArray$3(arr) {
  return (
    ...
    _unsupportedIterableToArray$5(arr) ||
...
var Polygon = function Polygon2(props) {
  var points = props.points,
    ...
    others = _objectWithoutProperties$a(props, _excluded$a);
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        "path",
        _extends$j({}, filterProps(others, true), {
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r) {
    return /* @__PURE__ */ reactExports.createElement(
      "circle",
      _extends$i({}, filterProps(props, false), adaptEventHandlers(props), {
        className: layerClass,
        cx,
        cy,
        r,
...
var Cross = function Cross2(_ref) {
  ...
  return /* @__PURE__ */ React.createElement(
    "path",
    _extends$h({}, filterProps(props, true), {
      ...
      },
      {
        ...
        value: function renderAxisLine() {
          var _this$props3 = this.props,
            ...
            others = _objectWithoutProperties$8(_this$props3, _excluded$8);
          ...
          var props = _objectSpread$j(
            _objectSpread$j(
              _objectSpread$j({}, filterProps(others, false)),
              {},
              {
                fill: "none",
              },
      ...
      },
      {
        ...
        value: function renderTicks() {
          ...
          var _this$props4 = this.props,
            ...
            others = _objectWithoutProperties$8(_this$props4, _excluded2$5);
    ...
    [
      ...
      },
      {
        ...
        value: function renderAxisLine() {
          ...
          var props = _objectSpread$i(
            _objectSpread$i({}, filterProps(this.props, false)),
            {},
            {
              fill: "none",
            },
      ...
      },
      {
        ...
        value: function renderTicks() {
          ...
          var customTickProps = filterProps(tick, false);
          var tickLineProps = _objectSpread$i(
            _objectSpread$i({}, axisProps),
            {},
            {
              fill: "none",
            },
...
var Trapezoid = function Trapezoid2(props) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        "path",
        _extends$e({}, filterProps(trapezoidProps, true), {
          className: layerClass,
...
function Shape(_ref2) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    shape = /* @__PURE__ */ reactExports.cloneElement(
      option,
      _objectSpread$g(_objectSpread$g({}, props), getPropsFromShapeOption(option)),
    );
  } else if (isFunction(option)) {
    shape = option(props);
      ...
      },
      {
        ...
        value: function renderLabels(sectors) {
          ...
          var labels = sectors.map(function (entry, i) {
            ...
            var labelProps = _objectSpread$f(
              _objectSpread$f(
                _objectSpread$f(_objectSpread$f({}, pieProps), entry),
                {},
                {
                  stroke: "none",
                },
      ...
      },
      {
        ...
        value: function renderSectorsStatically(sectors) {
          ...
          return sectors.map(function (entry, i) {
            ...
            var sectorProps = _objectSpread$f(
      ...
      },
      {
        ...
        value: function renderSectors() {
          ...
          if (
            ...
            sectors &&
            sectors.length &&
            (!prevSectors || !isEqual(prevSectors, sectors))
          ) {
...
_defineProperty$i(Pie, "getComposedData", function (_ref4) {
  ...
  var itemProps =
    item.type.defaultProps !== void 0
      ? _objectSpread$f(_objectSpread$f({}, item.type.defaultProps), item.props)
      : item.props;
...
var generatePrefixStyle = function generatePrefixStyle2(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function (res, entry) {
    return _objectSpread$e(
      _objectSpread$e({}, res),
      {},
      _defineProperty$h({}, entry + camelName, value),
    );
  }, {});
  result[name] = value;
  return result;
    ...
    [
      ...
      },
      {
        ...
        value: function handleTravellerMove(e) {
          ...
          this.setState(
            _defineProperty$g(
              _defineProperty$g({}, movingTravellerId, prevValue + delta),
              "brushMoveStartX",
              e.pageX,
            ),
            function () {
...
function typeguardBarRectangleProps(_ref, props) {
  var xProp = _ref.x,
    yProp = _ref.y,
    option = _objectWithoutProperties$6(_ref, _excluded$6);
        ...
        value: function renderBackground() {
          ...
          return data.map(function (entry, i) {
            ...
            var background = entry.background,
              rest = _objectWithoutProperties$5(entry, _excluded$5);
            if (!background) {
              return null;
            }
            var props = _objectSpread$b(
...
var formatAxisMap2 = function formatAxisMap3(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function (result, id) {
    ...
    var finalAxis = _objectSpread$a(
      _objectSpread$a(_objectSpread$a({}, axis), ticks),
      {},
      {
        realScaleType,
        x,
    ...
    [
      ...
      },
      {
        ...
        value: function isInRange(value) {
          ...
          return first <= last2
            ? value >= first && value <= last2
            : value >= last2 && value <= first;
        },
      },
    ],
    [
...
var createLabeledScales = function createLabeledScales2(options) {
  var scales = Object.keys(options).reduce(function (res, key) {
    return _objectSpread$a(
      _objectSpread$a({}, res),
      {},
      _defineProperty$d({}, key, ScaleHelper.create(options[key])),
    );
  }, {});
  return _objectSpread$a(
    ...
    [
      {
        ...
        value: function shouldComponentUpdate(_ref, nextState) {
          var viewBox = _ref.viewBox,
            restProps = _objectWithoutProperties$4(_ref, _excluded$4);
          var _this$props = this.props,
            viewBoxOld = _this$props.viewBox,
            restPropsOld = _objectWithoutProperties$4(_this$props, _excluded2$4);
          return (
              ...
              return /* @__PURE__ */ React.createElement(
                ...
                tick &&
                  CartesianAxis2.renderTickItem(
                    ...
                    ""
                      .concat(
                        isFunction(tickFormatter) ? tickFormatter(entry.value, i) : entry.value,
                      )
                      .concat(unit || ""),
                  ),
              );
    ...
    [
      {
        ...
        value: function renderTickItem(option, props, value) {
          ...
          if (/* @__PURE__ */ React.isValidElement(option)) {
            tickItem = /* @__PURE__ */ React.cloneElement(
              option,
              _objectSpread$5(
                _objectSpread$5({}, props),
                {},
...
function renderLineItem(option, props) {
  ...
  if (/* @__PURE__ */ React.isValidElement(option)) {
    ...
    var x1 = props.x1,
      ...
      y2 = props.y2,
      key = props.key,
      others = _objectWithoutProperties$3(props, _excluded$3);
...
var Line = /* @__PURE__ */ (function (_PureComponent) {
  function Line2() {
    ...
    _defineProperty$6(_this, "getStrokeDasharray", function (length, totalLength, lines) {
      ...
      return []
        .concat(
          _toConsumableArray$2(Line2.repeat(lines, count)),
          _toConsumableArray$2(remainLines),
          emptyLines,
        )
        .map(function (line) {
    ...
    [
      ...
      },
      {
        ...
        value: function repeat(lines, count) {
          var linesUnit =
            lines.length % 2 !== 0 ? [].concat(_toConsumableArray$2(lines), [0]) : lines;
          var result = [];
          for (var i = 0; i < count; ++i) {
      ...
      },
      {
        ...
        value: function renderDotItem(option, props) {
          ...
          if (/* @__PURE__ */ React.isValidElement(option)) {
            ...
            var key = props.key,
              dotProps = _objectWithoutProperties$2(props, _excluded2$2);
            var className = clsx(
              "recharts-line-dot",
              typeof option !== "boolean" ? option.className : "",
            );
        ...
        value: function renderArea(needClip, clipPathId) {
          ...
          if (
            ...
            ((!prevPoints && totalLength > 0) ||
              !isEqual(prevPoints, points) ||
              !isEqual(prevBaseLine, baseLine))
          ) {
        ...
        if (type === "category" && isCategorical) {
          ...
          if (!allowDuplicatedCategory) {
            domain = parseDomainOfCategoryAxis(childDomain, domain, child).reduce(function (
              ...
              return finalDomain.indexOf(entry) >= 0 || entry === "" || isNil(entry)
                ? finalDomain
                : [].concat(_toConsumableArray(finalDomain), [entry]);
            }, []);
          } else {
    ...
    function (result, id) {
      ...
      if (!entry.mirror && !entry.hide) {
        return _objectSpread(
          _objectSpread({}, result),
          {},
          _defineProperty({}, orientation, get(result, "".concat(orientation)) + entry.height),
        );
      }
      return result;
    },
