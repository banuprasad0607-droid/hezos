...
const r = (t2, r2, o2) => {
  ...
  o = (e, t2) => {
    for (const o2 in t2.fields) {
      ...
      s2 && s2.ref && "reportValidity" in s2.ref
        ? r(s2.ref, o2, e)
        : s2 && s2.refs && s2.refs.forEach((t3) => r(t3, o2, e));
    }
  },
  s$1 = (r2, s2) => {
    ...
    const n2 = {};
    for (const o2 in r2) {
      const c = get(s2.fields, o2),
        f = Object.assign(r2[o2] || {}, { ref: c && c.ref });
...
function i(r2, e) {
  for (var o2 = {}; r2.length; ) {
    ...
    if (
      ("unionErrors" in t2 &&
        t2.unionErrors.forEach(function (e2) {
    ...
    var o2 = {},
      s2 = function () {
        var s3 = r2[0],
          ...
          u2 = s3.path.join(".");
        if (!o2[u2])
          if ("invalid_union" === s3.code && s3.errors.length > 0) {
            var c = s3.errors[0][0];
            o2[u2] = { message: c.message, type: c.code };
          } else o2[u2] = { message: a2, type: i2 };
        if (
          ("invalid_union" === s3.code &&
            s3.errors.forEach(function (e2) {
...
function u(n2, t2, u2) {
  if (
    ...
    return function (o$1, a2, c) {
      try {
        return Promise.resolve(
          s(
            function () {
              return Promise.resolve(n2["sync" === u2.mode ? "parse" : "parseAsync"](o$1, t2)).then(
                function (e) {
                  return (
                    c.shouldUseNativeValidation && o({}, c),
                    { errors: {}, values: u2.raw ? Object.assign({}, o$1) : e }
                  );
                },
              );
            },
            function (r2) {
              if (
                ...
                return {
                  values: {},
                  errors: s$1(
                    i(r2.errors, !c.shouldUseNativeValidation && "all" === c.criteriaMode),
                    c,
                  ),
                };
              throw r2;
  ...
  if (
    ...
    return function (i2, c, f) {
      try {
        return Promise.resolve(
          s(
            function () {
              return Promise.resolve(("sync" === u2.mode ? parse : parseAsync)(n2, i2, t2)).then(
                function (e) {
                  return (
                    f.shouldUseNativeValidation && o({}, f),
                    { errors: {}, values: u2.raw ? Object.assign({}, i2) : e }
                  );
                },
              );
            },
            function (r2) {
              if (
                ...
                return {
                  values: {},
                  errors: s$1(
                    a(r2.issues, !f.shouldUseNativeValidation && "all" === f.criteriaMode),
                    f,
                  ),
                };
              throw r2;
