...
import { t as timeFormat, u as utcFormat } from "./d3-time-format.mjs";
import {
  s as second,
  b as timeMinute,
  a as timeHour,
  ...
  m as utcMonth,
  r as utcYear,
  p as utcTickInterval,
  q as utcTicks,
} from "./d3-time.mjs";
import {
  a as interpolateNumber,
  i as interpolate,
  b as interpolateRound,
  p as piecewise,
} from "./d3-interpolate.mjs";
import {
  b as formatSpecifier,
  p as precisionFixed,
  d as precisionRound,
  c as precisionPrefix,
  a as formatPrefix,
  f as format,
} from "./d3-format.mjs";
...
function transformer$2() {
  ...
  function scale(x) {
    return x == null || isNaN((x = +x))
      ? unknown
      : (output || (output = piecewise2(domain.map(transform), range2, interpolate$1)))(
          transform(clamp(x)),
        );
  }
  scale.invert = function (y) {
    return clamp(
      untransform(
        (input || (input = piecewise2(range2, domain.map(transform), interpolateNumber)))(y),
      ),
    );
  };
  scale.domain = function (_) {
...
export {
  ...
  radial as r,
  sequential as s,
  sequentialQuantile as t,
  sequentialSqrt as u,
  sequentialSymlog as v,
  sqrt as w,
  symlog as x,
  threshold as y,
  tickFormat as z,
