...
function processImage(img, canvas, radius, blurAlphaChannel, useOffset, skipStyles) {
  ...
  if (
    !img ||
    (Object.prototype.toString.call(img).slice(8, -1) === "HTMLImageElement" &&
      !("naturalWidth" in img))
  ) {
    return;
  }
...
const stackblurEs = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  BlurStack,
...
const require$$49 = /* @__PURE__ */ getAugmentedNamespace(stackblurEs);
export { require$$49 as r };
