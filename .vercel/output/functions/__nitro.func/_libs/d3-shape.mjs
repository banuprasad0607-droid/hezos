...
function shapeArea(x0, y0, y1) {
  ...
  area.x1 = function (_) {
    return arguments.length
      ? ((x1 = _ == null ? null : typeof _ === "function" ? _ : constant(+_)), area)
      : x1;
  };
  area.y = function (_) {
    return arguments.length
  ...
  area.y1 = function (_) {
    return arguments.length
      ? ((y1 = _ == null ? null : typeof _ === "function" ? _ : constant(+_)), area)
      : y1;
  };
...
function shapeStack() {
  ...
  stack.order = function (_) {
    return arguments.length
      ? ((order =
          _ == null ? stackOrderNone : typeof _ === "function" ? _ : constant(Array.from(_))),
        stack)
      : order;
  };
