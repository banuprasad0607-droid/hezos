...
function on(n, o) {
  ...
  if (a != null) {
    ...
    try {
      ...
      try {
        if (!I && a.return != null && ((b = a.return()), Object(b) !== b)) return;
      } finally {
        if (ne) throw f;
      }
    }
...
const Z = A(Array.prototype.forEach),
  un = A(Array.prototype.lastIndexOf),
  Rt = A(Array.prototype.pop),
  J = A(Array.prototype.push),
  mn = A(Array.prototype.splice),
  N = Array.isArray,
  ue = A(String.prototype.toLowerCase),
  Ye = A(String.prototype.toString),
  Ot = A(String.prototype.match),
  Q = A(String.prototype.replace),
  Nt = A(String.prototype.indexOf),
  pn = A(String.prototype.trim),
  dn = A(Number.prototype.toString),
  Tn = A(Boolean.prototype.toString),
...
function R(n) {
  ...
  for (const s of kt(n)) {
    ...
    d(n, f) &&
      (N(p)
        ? (o[f] = _n(p))
        : p && typeof p == "object" && p.constructor === Object
          ? (o[f] = R(p))
          : (o[f] = p));
  }
  return o;
...
function vt() {
  ...
  if (
    ((o.version = "3.4.7"),
    (o.removed = []),
    !n || !n.document || n.document.nodeType !== v.document || !n.Element)
  )
  ...
  const Le = n.DOMParser,
    ...
    Te = U(W, "shadowRoot"),
    Gt = U(W, "attributes"),
    w = b && b.prototype ? U(b.prototype, "nodeType") : null,
    Y = b && b.prototype ? U(b.prototype, "nodeName") : null;
  ...
  let O,
    oe = "";
  const ge = a,
    Ce = ge.implementation,
    Je = ge.createNodeIterator,
    Wt = ge.createDocumentFragment,
    Bt = ge.getElementsByTagName,
    jt = s.importNode;
  let E = Pt();
  o.isSupported =
    typeof kt == "function" && typeof de == "function" && Ce && Ce.createHTMLDocument !== void 0;
  const _e = yn,
    he = bn,
    Ae = Rn,
    Yt = On,
  ...
  const Qt = a.createElement("form"),
    ...
    Be = function () {
      ...
      ((!e || typeof e != "object") && (e = {}),
        (e = R(e)),
        (se = Zt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? Jt : e.PARSER_MEDIA_TYPE),
        (_ = se === "application/xhtml+xml" ? Ye : ue),
        (T = d(e, "ALLOWED_TAGS") && N(e.ALLOWED_TAGS) ? l({}, e.ALLOWED_TAGS, _) : we),
        (h = d(e, "ALLOWED_ATTR") && N(e.ALLOWED_ATTR) ? l({}, e.ALLOWED_ATTR, _) : Me),
        (ze =
          d(e, "ALLOWED_NAMESPACES") && N(e.ALLOWED_NAMESPACES)
            ? l({}, e.ALLOWED_NAMESPACES, Ye)
            : qt),
        (Ue =
          d(e, "ADD_URI_SAFE_ATTR") && N(e.ADD_URI_SAFE_ATTR)
            ? l(R(ct), e.ADD_URI_SAFE_ATTR, _)
            : ct),
        (st =
          d(e, "ADD_DATA_URI_TAGS") && N(e.ADD_DATA_URI_TAGS)
            ? l(R(lt), e.ADD_DATA_URI_TAGS, _)
            : lt),
        (P = d(e, "FORBID_CONTENTS") && N(e.FORBID_CONTENTS) ? l({}, e.FORBID_CONTENTS, _) : ve),
        (re = d(e, "FORBID_TAGS") && N(e.FORBID_TAGS) ? l({}, e.FORBID_TAGS, _) : R({})),
        (Ee = d(e, "FORBID_ATTR") && N(e.FORBID_ATTR) ? l({}, e.FORBID_ATTR, _) : R({})),
        (X = d(e, "USE_PROFILES")
        ...
        (ot = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
        (G = e.SAFE_FOR_TEMPLATES || !1),
        (ie = e.SAFE_FOR_XML !== !1),
        (B = e.WHOLE_DOCUMENT || !1),
        ($ = e.RETURN_DOM || !1),
        (Se = e.RETURN_DOM_FRAGMENT || !1),
        (ye = e.RETURN_TRUSTED_TYPE || !1),
        (ke = e.FORCE_BODY || !1),
        (rt = e.SANITIZE_DOM !== !1),
        (it = e.SANITIZE_NAMED_PROPS || !1),
        (Fe = e.KEEP_CONTENT !== !1),
        (ae = e.IN_PLACE || !1),
        (et = An(e.ALLOWED_URI_REGEXP) ? e.ALLOWED_URI_REGEXP : xt),
        (V = typeof e.NAMESPACE == "string" ? e.NAMESPACE : k),
        (Ge =
      ...
      if (
        ((g = ee(null)),
        d(t, "tagNameCheck") && ft(t.tagNameCheck) && (g.tagNameCheck = t.tagNameCheck),
        d(t, "attributeNameCheck") &&
          ft(t.attributeNameCheck) &&
          (g.attributeNameCheck = t.attributeNameCheck),
        ...
        X &&
          ((T = l({}, Ct)),
          (h = ee(null)),
          X.html === !0 && (l(T, Lt), l(h, wt)),
          X.svg === !0 && (l(T, $e), l(h, qe), l(h, Ie)),
          X.svgFilters === !0 && (l(T, Xe), l(h, qe), l(h, Ie)),
          X.mathMl === !0 && (l(T, Ve), l(h, Mt), l(h, Ie))),
        (z.tagCheck = null),
        (z.attributeCheck = null),
        d(e, "ADD_TAGS") &&
          (typeof e.ADD_TAGS == "function"
            ? (z.tagCheck = e.ADD_TAGS)
            : N(e.ADD_TAGS) && (T === we && (T = R(T)), l(T, e.ADD_TAGS, _))),
        d(e, "ADD_ATTR") &&
          (typeof e.ADD_ATTR == "function"
            ? (z.attributeCheck = e.ADD_ATTR)
            : N(e.ADD_ATTR) && (h === Me && (h = R(h)), l(h, e.ADD_ATTR, _))),
        d(e, "ADD_URI_SAFE_ATTR") && N(e.ADD_URI_SAFE_ATTR) && l(Ue, e.ADD_URI_SAFE_ATTR, _),
        d(e, "FORBID_CONTENTS") &&
          N(e.FORBID_CONTENTS) &&
          (P === ve && (P = R(P)), l(P, e.FORBID_CONTENTS, _)),
        d(e, "ADD_FORBID_CONTENTS") &&
          N(e.ADD_FORBID_CONTENTS) &&
          (P === ve && (P = R(P)), l(P, e.ADD_FORBID_CONTENTS, _)),
        Fe && (T["#text"] = !0),
        B && l(T, ["html", "head", "body"]),
        T.table && (l(T, ["tbody"]), delete re.tbody),
        ...
        (O === void 0 && (O = Mn(me, f)),
          O !== null && typeof oe == "string" && (oe = O.createHTML("")));
      ((E.uponSanitizeElement.length > 0 || E.uponSanitizeAttribute.length > 0) &&
        T === we &&
        (T = R(T)),
        E.uponSanitizeAttribute.length > 0 && h === Me && (h = R(h)),
        D && D(e),
        (q = e));
    },
    ut = l({}, [...$e, ...Xe, ...En]),
          ...
          : e.namespaceURI === be
            ? t.namespaceURI === k
              ...
              : t.namespaceURI === Re
                ...
                : !!mt[r]
            : e.namespaceURI === k
              ? (t.namespaceURI === Re && !We[u]) || (t.namespaceURI === be && !Ge[u])
                ? !1
                : !mt[r] && (Kt[r] || !ut[r])
              : !!(se === "application/xhtml+xml" && ze[e.namespaceURI])
        : !1;
    },
    M = function (e) {
    ...
    pt = function (e) {
      ...
      return (
        e && r && c.insertBefore(a.createTextNode(r), c.childNodes[0] || null),
        V === k ? Bt.call(t, B ? "html" : "body")[0] : B ? t.documentElement : c
      );
    },
    dt = function (e) {
      return Je.call(
    ...
    Oe = function (e) {
      const t = Y ? Y(e) : null;
      return typeof t != "string" || _(t) !== "form"
        ? !1
  ...
  const gt = function (e) {
      let t = null;
      if ((H(E.beforeSanitizeElements, e, null), Oe(e))) return (M(e), !0);
      const r = _(e.nodeName);
      if (
        (H(E.uponSanitizeElement, e, { tagName: r, allowedTags: T }),
        (ie &&
          e.hasChildNodes() &&
          !Ne(e.firstElementChild) &&
          y(/<[/\w!]/g, e.innerHTML) &&
          y(/<[/\w!]/g, e.textContent)) ||
          (ie && e.namespaceURI === k && r === "style" && Ne(e.firstElementChild)) ||
          e.nodeType === v.progressingInstruction ||
          (ie && e.nodeType === v.comment && y(/<[/\w]/g, e.data)))
      )
        return (M(e), !0);
      if (re[r] || (!(z.tagCheck instanceof Function && z.tagCheck(r)) && !T[r])) {
        if (
          !re[r] &&
          ht(r) &&
          ((g.tagNameCheck instanceof RegExp && y(g.tagNameCheck, r)) ||
            (g.tagNameCheck instanceof Function && g.tagNameCheck(r)))
        )
          return !1;
        if (Fe && !P[r]) {
          const c = de(e),
      ...
      return ((w ? w(e) : e.nodeType) === v.element && !en(e)) ||
        ...
        : (G &&
            ...
            e.textContent !== t && (J(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
          H(E.afterSanitizeElements, e, null),
          !1);
    },
    _t = function (e, t, r) {
        ...
        if (!(tt && y($t, t))) {
          if (!u || Ee[t]) {
            if (
              !(
                (ht(e) &&
                  ((g.tagNameCheck instanceof RegExp && y(g.tagNameCheck, e)) ||
                    (g.tagNameCheck instanceof Function && g.tagNameCheck(e))) &&
                  ((g.attributeNameCheck instanceof RegExp && y(g.attributeNameCheck, t)) ||
                    (g.attributeNameCheck instanceof Function && g.attributeNameCheck(t, e)))) ||
                (t === "is" &&
    ...
    At = function (e) {
      ...
      for (; u--; ) {
        ...
        if (
          ...
          H(E.uponSanitizeAttribute, e, r),
          (S = r.attrValue),
          it && (x === "id" || x === "name") && Nt(S, at) !== 0 && (j(m, e), (S = at + S)),
          ie &&
            y(
    ...
    De = function (e) {
      ...
      for (H(E.beforeSanitizeShadowDOM, e, null); (t = r.nextNode()); )
        if (
          (H(E.uponSanitizeShadowNode, t, null),
          gt(t),
          At(t),
          le(t.content) && De(t.content),
          (w ? w(t) : t.nodeType) === v.element)
        ) {
  ...
  return (
    (o.sanitize = function (i) {
      ...
      if (
        ((He = !i),
        He && (i = "<!-->"),
        typeof i != "string" && !Ne(i) && ((i = hn(i)), typeof i != "string"))
      )
      ...
      if ((Pe || Be(e), (o.removed = []), typeof i == "string" && (ae = !1), ae)) {
        ...
        if (typeof F == "string") {
          const x = _(F);
          if (!T[x] || re[x]) throw fe("root node is forbidden and cannot be sanitized in-place");
        }
        if (Oe(i)) throw fe("root node is clobbered and cannot be sanitized in-place");
        K(i);
      } else if (Ne(i))
        ((t = pt("<!---->")),
          (r = t.ownerDocument.importNode(i, !0)),
          (r.nodeType === v.element && r.nodeName === "BODY") || r.nodeName === "HTML"
            ? (t = r)
            : t.appendChild(r),
          K(r));
      else {
        if (!$ && !G && !B && i.indexOf("<") === -1) return O && ye ? O.createHTML(i) : i;
        if (((t = pt(i)), !t)) return $ ? null : ye ? oe : "";
      }
      t && ke && M(t.firstChild);
      const m = dt(ae ? i : t);
      for (; (u = m.nextNode()); ) (gt(u), At(u), le(u.content) && De(u.content));
      if (ae) return (G && Tt(i), i);
      if ($) {
        if ((G && Tt(t), Se))
          for (c = Wt.call(t.ownerDocument); t.firstChild; ) c.appendChild(t.firstChild);
        else c = t;
      ...
      return (
        B &&
          ...
          y(Ln, t.ownerDocument.doctype.name) &&
          (L =
            "<!DOCTYPE " +
            t.ownerDocument.doctype.name +
            `>
